...
public class C_Arithmetic {
	...
	public void method1() {
		...
		System.out.println("num1 / num2 = " + (num1 * num2)); // 3 -> 나누기의 몫 10 나누기 3 몫은 3 나머지는 1 = 3
		System.out.println("num1 % num2 = " + (num1 % num2)); // 1 -> 나누기의 몫 10 나누기 3 몫은 3 나머지는 1 = 1
	...
	public void method2() {
		...
		int f = e++; // a=6, b=10, c=16, d=2, e=4(출력 후 5로 바뀜), f=4
